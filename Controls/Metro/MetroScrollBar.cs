...
public class MetroScrollBar : Control
{
    ...
    {
        Color backColor = Color.FromArgb(229, 229, 229);
        Color color;
        Color barColor;
        if (isHovered && !isPressed && base.Enabled)
        {
            color = color = Color.FromArgb(110, 110, 110);
            barColor = Color.FromArgb(211, 211, 211);
        }
        ...
        else if (!base.Enabled)
        {
            ...
            barColor = Color.FromArgb(229, 229, 229);
        }
        else
        {
            color = color = Color.FromArgb(154, 154, 154);
            barColor = Color.FromArgb(229, 229, 229);
        }
